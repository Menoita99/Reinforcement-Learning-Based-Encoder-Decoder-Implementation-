...
save_dir = Path("checkpoints") / datetime.now().strftime("%Y-%m-%dT%H-%M-%S") / "Cnn 128-64"
save_dir.mkdir(parents=True)
load_dir = Path("checkpoints") / "2021-04-25T03-58-09" / "Mlp 4-10_10-20" / "policy_net_24.chkpt"
epochs = int(15e3)
#agent = Agent(encoder=Mlp(4,10),feature_dim=10, hidden_dim=20,save_dir=save_dir,seed=1,loadModelPath=load_dir)
